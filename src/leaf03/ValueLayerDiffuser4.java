...
public class ValueLayerDiffuser4 extends CustumValueLayerDiffuser {

	public ValueLayerDiffuser4(IGridValueLayer valueLayer, double evaporationConst,
		...
		if (size == 2) {
			...
			for (int y = 0; y < height; y++) {
				for (int x = 0; x < width; x++) {
					...
					double newVal = (oldVal + diffusionConst * (sum - 4.0 * oldVal)*0.25) * evaporationConst;
